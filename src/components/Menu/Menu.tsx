...
const Menu = () => {
  ...
  return (
    <>
      <div
        id='menu'
        className={`group/menu bg-[var(--bg-card)] border-r border-[var(--border)] fixed md:inset-y-0 md:flex md:flex-col transition-transform z-[999] top-0 left-0 h-full max-md:w-3/4 ${
