...
const ChatHistoryList = () => {
  ...
  return (
    <div
      className={`flex-col flex-1 overflow-y-auto hide-scroll-bar border-b border-[var(--border)] ${
        isHover ? 'bg-[var(--bg-sand)]/60' : ''
      }`}
      onDrop={handleDrop}
    ...
    >
      ...
      <div className='flex flex-col gap-0.5 mt-2 mb-2 text-[var(--fg-btn)] text-[13px]'>
