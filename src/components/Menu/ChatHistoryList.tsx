...
const ChatHistoryList = () => {
  ...
  return (
    <div
      className={`flex-col flex-1 overflow-y-auto hide-scroll-bar border-b border-[#f0eee6] dark:border-[#30302e] ${
        isHover ? 'bg-[#e8e6dc]/60 dark:bg-[#30302e]/40' : ''
      }`}
      onDrop={handleDrop}
    ...
    >
      ...
      <div className='flex flex-col gap-0.5 mt-2 mb-2 text-[#4d4c48] dark:text-[#b0aea5] text-[13px]'>
