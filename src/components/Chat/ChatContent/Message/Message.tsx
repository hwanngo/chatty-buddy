...
const Message = React.memo(
  ({
    ...
    return (
      <div
        className={`w-full group text-[var(--fg)] ${bg} border border-[var(--border)] rounded-xl overflow-hidden shadow-[rgba(0,0,0,0.03)_0px_2px_8px] dark:shadow-none`}
      >
        {advancedMode && (
          <div
          ...
          >
            ...
            {isDelete && (
              <>
                <button
                  className='p-1 rounded-md text-[var(--fg-3)] hover:text-[var(--fg)] hover:bg-[var(--border)] transition-colors cursor-pointer'
                  aria-label='cancel'
