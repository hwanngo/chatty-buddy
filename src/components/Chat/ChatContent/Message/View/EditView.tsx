    ...
    <div className='relative'>
      ...
      >
        <div className='relative flex items-center gap-1'>
          ...
          <textarea
            ref={textareaRef}
            className='m-0 resize-none rounded-lg bg-transparent overflow-y-hidden focus:ring-0 focus-visible:ring-0 leading-7 w-full placeholder:text-[var(--fg-3)]/60 pr-10'
            onChange={(e) => {
              _setContent((prev) => [
