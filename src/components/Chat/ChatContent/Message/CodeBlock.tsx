...
const CodeBar = React.memo(
  ({
    ...
    return (
      <div className='flex items-center relative text-[#faf9f5] bg-[#30302e] px-4 py-2 text-xs font-sans'>
        <span className=''>{lang}</span>
        <button
          className='flex ml-auto gap-2 transition-colors hover:text-[#b0aea5]'
