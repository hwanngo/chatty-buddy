...
const GooglePopup = ({
  ...
  return (
    <PopupModal
      ...
      cancelButton={false}
    >
      <div className='p-6 border-b border-[#f0eee6] dark:border-[#30302e] text-[#5e5d59] dark:text-[#b0aea5] text-sm flex flex-col items-center gap-4 text-center'>
        <p>{t('tagline')}</p>
        <GoogleSyncButton
          loginHandler={() => {
        ...
        />
        <p className='border border-[#e8e6dc] dark:border-[#30302e] px-3 py-2 rounded-lg text-[#5e5d59] dark:text-[#b0aea5]'>
          {t('notice')}
        </p>
...
const FileSelector = ({
  ...
  return (
    <label
      className={`w-full flex items-center justify-between mb-2 gap-2 text-sm font-medium text-[#4d4c48] dark:text-[#b0aea5] ${
    ...
    >
      ...
      <div className='flex-1 text-left'>
        {isEditing ? (
          <input
            type='text'
            className='text-[#141413] dark:text-[#faf9f5] p-3 text-sm border-none bg-[#e8e6dc] dark:bg-[#30302e] rounded-lg m-0 w-full mr-0 h-8 focus:outline-none'
            value={_name}
            onChange={(e) => {
